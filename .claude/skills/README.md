...
`engineering-insights` is authored in this repo. Every other skill is vendored from
GitHub and pinned by hash in `../../skills-lock.json` — locally-authored skills have no
upstream and do not belong in that lockfile.
