    ...
    <>
      ...
      >
        <div style={s.statsRow}>
          ...
          <Stat label={t("trace.stat.tokens")} val={formatTokenFlow(stats.tokens_in, stats.tokens_out)} />
          {/* Traces persisted while cost was absent from the contract have no
              `cost_usd` key at all (the trace is cast, not Zod-parsed, on read),
              so this legitimately receives undefined → "—". */}
