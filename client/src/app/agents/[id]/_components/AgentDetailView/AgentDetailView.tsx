/* Agent Editor screen — /agents/:id (A2, L03). Left agent list + Config editor
   (model + system prompt). Tab state lives in ?tab=. */
"use client";
...
import { DEFAULT_TAB, VALID_TABS } from "../AgentEditor/constants";
