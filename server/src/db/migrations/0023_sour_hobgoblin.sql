...
ALTER TABLE "multi_agent_runs" ADD COLUMN "notes" jsonb;--> statement-breakpoint
...
CREATE INDEX "multi_agent_runs_pr_ran_idx" ON "multi_agent_runs" USING btree ("pr_id","ran_at" DESC NULLS LAST);